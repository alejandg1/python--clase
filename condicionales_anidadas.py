estudiantes = [
    {'nombre': 'Alejandro', 'sexo': 'M', 'carrera': 'soft', 'estado S.E.': 'medio',
        'promedio': 80, 'asistencia': 100, 'beca': False, 'deuda': 7, 'tipo de beca': ""},
    ...
    {'nombre': 'Carlos', 'sexo': 'F', 'carrera': 'med', 'estado S.E.': 'medio bajo',
     'promedio': 75, 'asistencia': 80, 'beca': False, 'deuda': 0, 'tipo de beca': ""},
    ...
    {'nombre': 'Martha', 'sexo': 'F', 'carrera': 'soft', 'estado S.E.': 'medio',
     'promedio': 62, 'asistencia': 55, 'beca': False, 'deuda': 0, 'tipo de beca': ""},
    {'nombre': 'Camille', 'sexo': 'F', 'carrera': 'soft', 'estado S.E.': 'bajo',
     'promedio': 80, 'asistencia': 90, 'beca': False, 'deuda': 0, 'tipo de beca': ""},
    {'nombre': 'Andres', 'sexo': 'M', 'carrera': 'med', 'estado S.E.': 'bajo',
...
def beca_academica():
    ...
    for i in estudiantes:
        ...
        if i['deuda'] == 0:
            ...
            cumpled = False
        if (cumplep & cumplea & cumpled & apto):
            i['beca'] = True
            i['tipo de beca'] = "a"
            print(
...
def beca_socioeconomica():
    ...
    for i in estudiantes:
        ...
        if i['deuda'] == 0:
            ...
            cumpled = False
        if (cumplep & cumplea & cumpled & apto & socioe):
            i['beca'] = True
            i['tipo de beca'] = "s.e."
            print(
                f"beca otorgada a {i['nombre']}: {i['beca']}, tipo: {i['tipo de beca']}  ")
